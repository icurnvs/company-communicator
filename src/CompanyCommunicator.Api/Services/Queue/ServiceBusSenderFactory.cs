...
namespace CompanyCommunicator.Api.Services.Queue;

/// <summary>
/// Provides <see cref="ServiceBusSender"/> instances by queue name.
/// Uses a pre-built dictionary of senders to avoid repeated <c>CreateSender</c> calls
/// on the underlying <see cref="ServiceBusClient"/> (senders are safe to reuse).
/// </summary>
