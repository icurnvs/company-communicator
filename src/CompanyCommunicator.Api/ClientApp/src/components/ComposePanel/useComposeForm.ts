...
export function useComposeForm({
  ...
  const form = useForm<ComposeFormValues>({
    ...
    defaultValues: {
      ...
      keyDetails: initialValues?.keyDetails ?? [],
      ...
      additionalSlots: initialValues?.additionalSlots ?? null,
      advancedOverrides: initialValues?.advancedOverrides ?? null,
      cardSettings: initialValues?.cardSettings ?? null,
      slotOrder: initialValues?.slotOrder ?? null,
      allUsers: false,
      audiences: [],
    },
  });
  ...
  useEffect(() => {
    ...
    form.reset({
      ...
      additionalSlots: templateMeta?.additionalSlots ?? null,
      advancedOverrides: templateMeta?.advancedOverrides ?? null,
      cardSettings: templateMeta?.cardSettings ?? null,
      slotOrder: templateMeta?.slotOrder ?? null,
